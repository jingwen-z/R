...
\noindent{Here, I get the individual level treatment effects are \\ \Sexpr{it[1:NC]}}
...
\noindent{Here, I get the individual level treatment effects are \\
\Sexpr{its[1:NS]}}
...
\noindent{According to this graph, we observe that the result is similar to yours.\\
\textbf{It indicates that ...}}
...
\noindent{According to this graph, we can get that the result is similar to yours.\\
\textbf{It indicates that ...}}
\clearpage
...
\noindent{\textbf{It indicates that ...}}
...
<<LLR.fuzzy.y,eval=TRUE,echo=FALSE,results='hide',cache=TRUE>>=
...
<<plot.fuzzy.rdd.3,dependson='LLR.fuzzy.pscore',eval=TRUE,echo=FALSE,results='hide',fig.cap='Fuzzy RDD',fig.align='center',out.width='.5\\textwidth',out.height='.5\\textwidth',fig.width=8,fig.height=8,fig.pos='htbp'>>=
plot(yBo[Dsc==0],y0o[Dsc==0],pch=1,xlim=c(4,10.5),ylim=c(4,10.5),xlab="yB",ylab="Outcomes")
points(yBo[Dsc==1],yc[Dsc==1],pch=3,col=col.obs)
